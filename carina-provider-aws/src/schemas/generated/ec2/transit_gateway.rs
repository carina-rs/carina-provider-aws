    ...
    AwsSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("options", AttributeType::struct_(
                ...
                Some(carina_core::schema::string_enum_identity("AutoAcceptSharedAttachments", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("DefaultRouteTableAssociation", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("DefaultRouteTablePropagation", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("DnsSupport", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("MulticastSupport", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("SecurityGroupReferencingSupport", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("VpnEcmpSupport", Some("aws.ec2.TransitGateway.TransitGatewayRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
