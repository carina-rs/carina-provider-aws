    ...
    AwsSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("options", AttributeType::struct_(
                ...
                Some(carina_core::schema::string_enum_identity("ApplianceModeSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions"))),
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("DnsSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("Ipv6Support", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
                ...
                vec!["disable".to_string(), "enable".to_string()],
                Some(carina_core::schema::string_enum_identity("SecurityGroupReferencingSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions"))),
                vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())],
