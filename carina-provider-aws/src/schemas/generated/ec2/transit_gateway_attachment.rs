    ...
    AwsSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("options", AttributeType::struct_(
                    ...
                    vec![
                    StructField::new("appliance_mode_support", AttributeType::enum_(carina_core::schema::enum_identity("ApplianceModeSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions")), Some(vec!["disable".to_string(), "enable".to_string()]), vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())], None, None)).with_description("Enable or disable support for appliance mode. If enabled, a traffic flow between a source and destination uses the same Availability Zone for the VPC ...").with_provider_name("ApplianceModeSupport"),
                    StructField::new("dns_support", AttributeType::enum_(carina_core::schema::enum_identity("DnsSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions")), Some(vec!["disable".to_string(), "enable".to_string()]), vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())], None, None)).with_description("Enable or disable DNS support. The default is enable.").with_provider_name("DnsSupport"),
                    StructField::new("ipv6_support", AttributeType::enum_(carina_core::schema::enum_identity("Ipv6Support", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions")), Some(vec!["disable".to_string(), "enable".to_string()]), vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())], None, None)).with_description("Enable or disable IPv6 support. The default is disable.").with_provider_name("Ipv6Support"),
                    StructField::new("security_group_referencing_support", AttributeType::enum_(carina_core::schema::enum_identity("SecurityGroupReferencingSupport", Some("aws.ec2.TransitGatewayAttachment.CreateTransitGatewayVpcAttachmentRequestOptions")), Some(vec!["disable".to_string(), "enable".to_string()]), vec![("disable".to_string(), "disable".to_string()), ("enable".to_string(), "enable".to_string())], None, None)).with_description("Enables you to reference a security group across VPCs attached to a transit gateway to simplify security group management. This option is set to enabl...").with_provider_name("SecurityGroupReferencingSupport")
                    ],
                ))
                .create_only()
