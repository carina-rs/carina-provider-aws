    ...
    AwsSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("private_dns_name_options_on_launch", AttributeType::struct_(
                    ...
                    StructField::new("hostname_type", AttributeType::enum_(
    carina_core::schema::enum_identity("HostnameType", Some("aws.ec2.Subnet.PrivateDnsNameOptionsOnLaunch")),
    Some(vec!["ip-name".to_string(), "resource-name".to_string()]),
