...
pub fn ec2_flow_log_config() -> AwsSchemaConfig {
    AwsSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("log_destination_type", AttributeType::enum_(carina_core::schema::enum_identity("LogDestinationType", Some("aws.ec2.FlowLog")), Some(vec!["cloud-watch-logs".to_string(), "kinesis-data-firehose".to_string(), "s3".to_string()]), vec![("cloud-watch-logs".to_string(), "cloud_watch_logs".to_string()), ("kinesis-data-firehose".to_string(), "kinesis_data_firehose".to_string()), ("s3".to_string(), "s3".to_string())], None, None))
                .create_only()
        ...
        .attribute(
            AttributeSchema::new("resource_type", AttributeType::enum_(carina_core::schema::enum_identity("ResourceType", Some("aws.ec2.FlowLog")), Some(vec!["NetworkInterface".to_string(), "RegionalNatGateway".to_string(), "Subnet".to_string(), "TransitGateway".to_string(), "TransitGatewayAttachment".to_string(), "VPC".to_string()]), vec![("NetworkInterface".to_string(), "network_interface".to_string()), ("RegionalNatGateway".to_string(), "regional_nat_gateway".to_string()), ("Subnet".to_string(), "subnet".to_string()), ("TransitGateway".to_string(), "transit_gateway".to_string()), ("TransitGatewayAttachment".to_string(), "transit_gateway_attachment".to_string()), ("VPC".to_string(), "vpc".to_string())], None, None))
                .required()
                .create_only()
